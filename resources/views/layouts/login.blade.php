        ...
        <div class="row rounded-5 p-3 bg-white shadow box-area">
            <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box"
                ...
                <div class="featured-image mb-3">
                    <img src="img/gambar2.png" class="img-fluid" style="width: 250px;">
                </div>
                <p class="text-white fs-2" style="font-family: 'Courier New', Courier, monospace; font-weight: 600;">Be
                    Verified</p>
                <small class="text-white text-wrap text-center"
                    style="width: 17rem;font-family: 'Courier New', Courier, monospace;">Ayo gabung disini untuk menjadi
                    bagian dari tenant bandara jambi</small>
            </div>
            ...
            <div class="col-md-6 right-box">
                <div class="row align-items-center">
                    ...
                    <div class="row">
                        <small>Don't have account? <a href="{{ route('registrasi') }}">Sign Up</a></small>
                    </div>
                </div>
            </div>
        </div>
